...
export default function CategoryManager({ customCategories, onAddCategory, onRemoveCategory }) {
          ...
          <div className="flex flex-wrap gap-2">
            {allCategories.map((cat) => {
              ...
              return (
                <div
                  key={cat}
                  className="flex items-center gap-1.5 pl-2.5 pr-1.5 py-1 rounded-full border border-gray-200 bg-gray-50 text-sm"
                >
                  <span
